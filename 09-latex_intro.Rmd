# Hvordan skrive SKDE rapport i LaTeX {#introlatex}
...
Bruker `\input{filnavn}` for å legge inn andre LaTeX-fileri, der all teksten ligger. "side2" er gitt [under](\@ref(side2tex)).
