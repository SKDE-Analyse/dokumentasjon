...
```{r, echo=FALSE}
knitr::include_graphics("figurer/nySASserver2.png")
```

- Markér din nylagde profil og trykk på *Set Active*. Trykk *OK* på advarsel som kommer opp.

```{r, echo=FALSE}
knitr::include_graphics("figurer/nySASserver3.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("figurer/nySASserver4.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("figurer/nySASserver_utforsker1.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("figurer/nySASserver_utforsker2.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("figurer/nySASserver_utforsker3.png")
```
...
- Dokumentasjon kan finnes [her](http://skde-analyse.github.io/rateprogram/)
- Koden ligger på [*github*](https://github.com/SKDE-Analyse/rateprogram)
